...
public class PlusFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txt9=rootView.findViewById(R.id.txt9);
        btadd1=rootView.findViewById(R.id.btadd1);
        btadd2=rootView.findViewById(R.id.btadd2);
        btadd3=rootView.findViewById(R.id.btadd3);
        btadd4=rootView.findViewById(R.id.btadd4);
        btadd5=rootView.findViewById(R.id.btadd5);
        btadd6=rootView.findViewById(R.id.btadd6);
        btadd7=rootView.findViewById(R.id.btadd7);
        btadd8=rootView.findViewById(R.id.btadd8);
        btadd9=rootView.findViewById(R.id.btadd9);
        btsub1=rootView.findViewById(R.id.btsub1);
        btsub2=rootView.findViewById(R.id.btsub2);
        btsub3=rootView.findViewById(R.id.btsub3);
        btsub4=rootView.findViewById(R.id.btsub4);
        btsub5=rootView.findViewById(R.id.btsub5);
        btsub6=rootView.findViewById(R.id.btsub6);
        btsub7=rootView.findViewById(R.id.btsub7);
        btsub8=rootView.findViewById(R.id.btsub8);
        btsub9=rootView.findViewById(R.id.btsub9);
